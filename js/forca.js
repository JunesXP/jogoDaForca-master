...
function mudarStyleLetra(tecla, condicao){
    if(condicao == false)
    {
        document.getElementById(tecla).style.background = "#f50c0c";
...
function carregaImagemForca(){
    switch(tentativas){
        ...
        case 3:
            ...
            break;
       default:
            document.getElementById("imagem").style.background  = "url('./img/forca11.png')";
            break;
